...
for path in $dockerfiles; do
  ...
  echo "docker tag "orangesys/alpine-kong:${tag}" "asia.gcr.io/orange-sys/alpine-kong:${tag}""
  echo "sudo /opt/google-cloud-sdk/bin/gcloud docker push asia.gcr.io/orange-sys/alpine-kong:${tag}"
